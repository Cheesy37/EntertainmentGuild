...
namespace EntertainmentGuild.Controllers
{
    public class GamesController : Controller
    {
        ...
        public GamesController(EntertainmentGuildContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Game != null ? 
                          ...
                          Problem("Entity set 'EntertainmentGuildContext.Game'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EntertainmentGuildContext.Game'  is null.");
            }
            var game = await _context.Game.FindAsync(id);
            if (game != null)
            {
